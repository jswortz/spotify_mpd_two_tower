...
class TrainTfSeqExampleDoFn(beam.DoFn):
    ...
    def process(self, data):
        ...
        for x in data['track_instrumentalness_pl']:
            ragged_dict['track_instrumentalness_pl'].append(x)
        ...
        track_instrumentalness_pl = tf.train.FloatList(value=ragged_dict['track_instrumentalness_pl'])
        ...
        track_instrumentalness_pl = tf.train.FeatureList(feature=[tf.train.Feature(float_list=track_instrumentalness_pl)])
        ...
        seq = tf.train.SequenceExample(
            ...
            feature_lists=tf.train.FeatureLists(
                feature_list={
                    ...
                    'track_instrumentalness_pl': track_instrumentalness_pl,
